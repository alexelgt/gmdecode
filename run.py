                        ...
                        try:
                            ...
                            if is_template_id and isinstance(
                                ...
                                if blocks_meta_element['enum_key_default_value']:
                                    ...
                                    _, enum_key = blocks_meta_element['regex_find'].search(element['templateId']).groups()
                                else:
                                ...
                                enum_value = element['data'][blocks_meta_element['element_first_level']][blocks_meta_element['element_second_level']]
